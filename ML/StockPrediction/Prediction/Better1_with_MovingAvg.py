...
test_set_name = '/home/antarix/Desktop/naive bayes/Stocks/Data/LUPIN.csv'
#
#
import os
ohlcv_histories = 0
...
ohlcv_histories, technical_indicators, next_day_open_values, unscaled_y, y_normaliser = csv_to_dataset('/home/antarix/Desktop/naive bayes/Stocks/Data/LUPIN.csv')
print("<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>??????????????????????????")
