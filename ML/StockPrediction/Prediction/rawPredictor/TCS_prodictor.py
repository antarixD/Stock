...
from ML.StockPrediction.Prediction.TCS.util_High import csv_to_dataset, history_points
import ML.utils.pd_file as pdutils

#-------------------reading the file ------------------------#
test_set_name = '/home/antarix/Desktop/naive bayes/Stocks/Data/CALSOFT.csv'
...
model.fit(x=[ohlcv_train, tech_ind_train], y=y_train, batch_size=32, epochs=2, shuffle=True, validation_split=0.1)
