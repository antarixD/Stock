...
last_thirty_day = dateUtils.last_thirty_day(today,365)
fourthWeekDate = dateUtils.last_thirty_day(today,91)
thirdWeekDate = dateUtils.last_thirty_day(today,182)
secondWeekDate = dateUtils.last_thirty_day(today,273)
...
path = path + '/data'  +'/best_performing_stocks_yearly_'+last_day+'.csv'
